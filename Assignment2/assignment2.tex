...
\begin{document}
	...
	Best fit a straight line to it , $e_i$ are the corresponding residual errors
      	...
      	\end{align}
SSE is sum of square of errors ,for minimizing use gradient wrt A, substitue E from above equation and get A
      \begin{align}
        ...
        \\
        \implies \brak{\vec{X}^{\top}\vec{X}\vec{A}-\vec{X}^{\top}\vec{Y}}=0
        \\
        \implies \vec{A}=\brak{\vec{X}^{\top}\vec{X}}^{-1}\vec{X}^{\top}\vec{Y}
      \end{align}
